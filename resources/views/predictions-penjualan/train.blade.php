...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Train Model Penjualan</li>
    </ol>
@endsection
...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="resetForm" action="{{ route('reset-penjualan') }}" method="POST" style="display: inline;">
                            @csrf
                    ...
                    <div class="card-body">
                        <h1>Histori Training Penjualan</h1>
                        <div class="table-responsive">
                            <table id="trainingHistoriesTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($trainingHistoriesPenjualan as $history)
                                        <tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('delete-training-history', $history->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        {{ $trainingHistoriesPenjualan->links() }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#trainingHistoriesTable').DataTable({
                "paging": true,
                "lengthChange": false,
                "searching": true,
                "ordering": true,
